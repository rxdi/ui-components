...
// graphql typescript definitions
  ...
  */
  export interface IMutation {
    __typename?: "Mutation";
    clickHamburgerButton: IHambuergerStatisticsType | null;
}

  
  export interface IHambuergerStatisticsType {
    __typename?: "HambuergerStatisticsType";
    clicks: number | null;
}
  ...
  */
  export interface ISubscription {
    ...
    subscribeToStatistics: IHambuergerStatisticsType | null;
}
